const Removal = (event) => {
	...
	event.remove({ output: 'minecraft:glass', input: 'minecraft:sand'})
	event.remove({ output: 'gtceu:glass_dust', type: 'gtceu:mixer'})
	event.remove({ output: 'gtceu:glass_dust', input: 'gtceu:quartz_sand_dust'})
}