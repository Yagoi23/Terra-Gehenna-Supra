const Removal = (event) => {
	...
	event.remove({ output: 'enchanted:oil_of_vitriol'})
	...
	event.remove({ type: 'tconstruct:casting_basin'})
	event.remove({ type: 'tconstruct:casting_table'})
	event.remove({ output: 'create:andesite_alloy'})
	//event.remove({ type: 'tconstruct:casting_basin', input:'#minecraft:planks', not: {output: 'gtceu:treated_wood_plankss'} })
	//event.remove({ type: 'tconstruct:casting_basin', input: '#minecraft:wooden_stairs' })
	//event.remove({ type: 'tconstruct:casting_basin', input: '#minecraft:wooden_slabs' })
	//event.remove({ type: 'tconstruct:casting_basin', input: '#minecraft:fences' })
	//event.remove({ type: 'tconstruct:casting_basin', input: '#tconstruct:congealed_slime' })
	event.remove({ output: 'tconstruct:cheese_block' })
	event.remove({ output: 'minecraft:honey_block' })
	...
	//event.remove({ type: 'tconstruct:casting_basin', input: '#minecraft:walls' })
	//event.remove({ type: 'tconstruct:casting_basin', input: '#minecraft:stairs' })
	//event.remove({ type: 'tconstruct:casting_basin', input: '#minecraft:slabs' })
	//event.remove({ type: 'tconstruct:casting_basin', input: 'minecraft:dirt' })
	event.remove({ input: 'tconstruct:enderbark_roots' })
